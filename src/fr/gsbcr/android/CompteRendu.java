...
public class CompteRendu {
	 ...
	 * 
	 * @param collaborateur
	 *            collaborateur ayant rédiger le compte rendu
	 * @param iNumCR
	 *            Numéro du compte rendu
	 * @param praticien
	 *            Praticien concerné par le compte rendu
	 * @param dDateCR
	 *            Date de rédaction du compte rendu
	 * @param dDateVisite
	 *            Date de visite
	 * @param sBilanCR
	 *            Bilan contenu dans le compte rendu
	 * @param sMotifCR
	 *            Motif du compte rendu
	 * @param iCoefConfCR
	 *            Coefficient de confiance
	 * @param byEstLuCR
	 *            Etat de lecture du compte rendu
	 */
	public CompteRendu(Collaborateur collaborateur, int iNumCR,
			Praticien praticien, Date dDateCR, Date dDateVisite,
			String sBilanCR, Motif sMotifCR, int iCoefConfCR, String byEstLuCR) {
		super();
	 ...
	 * 
	 * @param collaborateur
	 *            Le nouveau collaborateur à définir
	 */
	 ...
	 * 
	 * @param iNumCR
	 *            Le nouveau numéro du compte rendu
	 */
	 ...
	 * 
	 * @param praticien
	 *            Le nouveau praticien à définir
	 */
	 ...
	 *            Le nouveau motif
	 */
	public void setsMotifCR(Motif sMotifCR) {
		this.sMotifCR = sMotifCR;
	}
	 ...
	 * 
	 * @param iCoefConfCR
	 *            Le nouveau coefficient de confiance
	 */
